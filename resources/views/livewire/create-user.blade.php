<div x-cloak class="px-10">
    <div class="my-10">
        <h2 class="text-center text-2xl font-semibold">Create User</h2>
        ...
        <div class="my-10">
            <form wire:submit="save" class="space-y-6">
                ...
                <x-forms.panel>
                    ...
                    <x-forms.input wire:model.live="password_confirmation" type="password"
                ...
                <x-forms.panel>
                    <div class="flex justify-between ">
                        ...
                        <button type="submit"
                                class="py-2 px-6 rounded-md text-white bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 transition duration-300">
                            Create
                        </button>
                    </div>
                </x-forms.panel>
