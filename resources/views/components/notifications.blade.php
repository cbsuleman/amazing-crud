<div x-data="{
     ...
     @notify-danger.window="
        let mid = Date.now();
        if (messages.length > 0) {
            messages = [];
        }
        messages.push({id: mid, msg: $event.detail});
        setTimeout(() => { remove(mid) }, 2000);
    "
